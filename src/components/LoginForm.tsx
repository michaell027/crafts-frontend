        ...
        <div className="lg:w-1/2 bg-green-300/20 rounded-r-3xl w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
          ...
          <div className="w-full py-6 z-20">
            <div className="flex flex-col items-center justify-center gap-4 max-w-sm pb-4 ">
              ...
              {/*<button type="button"*/}
              {/*        className="py-2 px-4 flex justify-center items-center  bg-gray-600 hover:bg-gray-700 focus:ring-gray-500 focus:ring-offset-gray-200 text-white w-56 transition ease-in duration-200 text-center text-sm font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">*/}
            ...
            <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
              ...
              <div className="px-4 pb-2 pt-4 flex items-center justify-center">
                <button className="block w-fit py-2.5 px-6 text-lg rounded-2xl bg-green-700 hover:bg-green-900 focus:outline-none">
                  Sign In
                </button>
              </div>
            </form>
